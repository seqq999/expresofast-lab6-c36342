...
import cr.ac.ucr.paraiso.ie.c36342.lab5.expresofast.data.EnvioRepository;
import cr.ac.ucr.paraiso.ie.c36342.lab5.expresofast.data.VehiculoRepository;
import cr.ac.ucr.paraiso.ie.c36342.lab5.expresofast.data.BitacoraEnvioRepository;
...
public class EnvioService {
    ...
    private void validteWeigth(BigDecimal peso, BigDecimal capacidad) {
        ...
        if (peso.compareTo(capacidad) > 0) {
            throw new EnvioException("El peso del envío supera la capacidad del vehículo");
        }
    }
